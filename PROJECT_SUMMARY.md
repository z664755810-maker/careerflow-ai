...
>
> 文中所有事实均来自当前代码库（截至 2026-09-01 提交 `976ea45` + `31c0a26`；2026-09-07 新增「分析缓存去重 + 强制重算」与「前端 Element Plus 按需引入」，详见 **`PROJECT_SUMMARY_UPDATES.md`**），可直接引用。
...
| 质量保障 | **pytest-asyncio + ruff** | 29 个测试全过；lint 零告警 |
